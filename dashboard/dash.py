...
# Load data
day_df = pd.read_csv(r"C:\Users\clari\test\dashboard_streamlit\proyek_analisis_data\dashboard\cleaned_day.csv")
hour_df = pd.read_csv(r"C:\Users\clari\test\dashboard_streamlit\proyek_analisis_data\dashboard\cleaned_hour.csv")
