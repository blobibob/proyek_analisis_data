...
# Load data
hour_df = pd.read_csv(r"C:\Users\clari\test\dashboard_streamlit\cleaned_hour.csv")
day_df = pd.read_csv(r"C:\Users\clari\test\dashboard_streamlit\cleaned_day.csv")
